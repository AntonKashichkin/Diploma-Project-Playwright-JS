...
test.describe('API testing', () => {
  ...
  test('6. Todos ID negativ @get @api', async ({ api }, testinfo) => {
  ...
  test('7. Todos filter @get @api', async ({ api }, testinfo) => {
  ...
  test('8. Todos  @head @api', async ({ api }, testinfo) => {
    let response = await api.todos.head(token, testinfo);
    expect(response.status()).toBe(200);
  });

  test('9. Todos  @post @api', async ({ api }, testinfo) => {
  ...
  test('10. Todos doneStatus  @post @api', async ({ api }, testinfo) => {
  ...
  test('11. Todos title too long  @post @api', async ({ api }, testinfo) => {
  ...
  test('12. Todos description too long  @post @api', async ({ api }, testinfo) => {
  ...
  test('13. Todos max size content  @post @api', async ({ api }, testinfo) => {
  ...
  test('14. Todos Content too long  @post @api', async ({ api }, testinfo) => {
  ...
  test('15. Todos priority @post @api', async ({ api }, testinfo) => {
  ...
  test('16. Todos put @put @api', async ({ api }, testinfo) => {
  ...
  test('17. Update title @post @api', async ({ api }, testinfo) => {
  ...
  test('18. Updating a task of a non-existent task @post @api', async ({ api }, testinfo) => {
  ...
  test('19. Fill change task @put @api', async ({ api }, testinfo) => {
  ...
  test('20. Partial update @put @api', async ({ api }, testinfo) => {
  ...
  test('21. No title @put @api', async ({ api }, testinfo) => {
  ...
  test('22. No amend id @put @api', async ({ api }, testinfo) => {
  ...
  test('23. Delete todo @delete @api', async ({ api }, testinfo) => {
  ...
  test('24. Options @options @api', async ({ api }, testinfo) => {
  ...
  test('27. Todos ANY @get @api', async ({ api }, testinfo) => {
  ...
  test('28. Todos XMLandJSON  @get @api', async ({ api }, testinfo) => {
    let xml = await api.todos.getXMLandJSON(token, testinfo);
    expect(xml).toContain('<doneStatus>false</doneStatus>');
  });

  test('29. Todos no acept @get @api', async ({ api }, testinfo) => {
  ...
  test('30. Todos gzip @get @api', async ({ api }, testinfo) => {
  ...
  test('31. Create todos XML @post @api', async ({ api }, testinfo) => {
  ...
  test('32. Create todos JSON @post @api', async ({ api }, testinfo) => {
  ...
  test('33. Create todos unsupported Content-Type @post @api', async ({ api }, testinfo) => {
  ...
  test('34. Return the progress data @get @api', async ({ api }, testInfo) => {
  ...
  test('35. Restore that challengers progress into memory @put @api', async ({ api }, testInfo) => {
